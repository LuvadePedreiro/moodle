...
- [@014 @014 L1 - Quantos são iguais?](base/014) 
...
- [@020 @020 L2 - Zerinho ou Um!](base/020) 


## 06. Seleção: Operador de módulo
- [@062 @062 L2 - Angulo Cartesiano](base/062) 
...
- [@005 @005 L2 - Ladrão de Goiabas](base/005) 
...
- [@021 @021 L2 - Aumento de Salário](base/021) 
- [@032 @032 L2 - Bolada na fuça](base/032) 
- [@183 @183 L2 - Criança ou Múmia](base/183) 

## 08. Seleção: Busca e Contagem
- [@017 @017 L2 - Maior ovo](base/017) 
- [@192 @192 L2 - A idade de Dona Mônica - OBI 2019 - F1PJ](base/192) 
- [@029 @029 L2 - Quiz do Harry Potter](base/029) 
- [@036 @036 L3 - Morre o do meio](base/036) 
- [@033 @033 L3 - Professor Bonzinho](base/033) 

## 09. Seleção: Conversão
- [@038 @038 L2 - Próximo segundo](base/038) 
- [@027 @027 L2 - Adedonha](base/027) 
- [@043 @043 L3 - Horas de sono](base/043) 
...
- [@047 @047 L2 - Ônibus lotado](base/047) 
- [@049 @049 L2 - Sapinho 1 no Poço](base/049) 
- [@059 @059 L3 - Sapinho 2 morrendo no poço](base/059) 
- [@065 @065 L3 - Sapinho 3 matemático](base/065) 
- [@050 @050 L2 - Castelos de Cubos](base/050) 
- [@054 @054 L3 - Quebrador de Copos](base/054) 

## 12. Laço: Math
- [@090 @090 L2 - Primo](base/090) 
- [@189 @189 L2 - Fatores de um número](base/189) 
- [@052 @052 L3 - Sopa de coelho?](base/052) 
- [@160 @160 L3 - Somatório de Fibonacci](base/160) 
- [@066 @066 L2 - Spok Palíndromo](base/066) 
- [@064 @064 L3 - Conta Dígitos](base/064) 
...
- [@058 @058 L2 - Busca Intervalada](base/058) 
...
- [@077 @077 L3 - Mercantil V3 - Muitas rodadas](base/077) 
...
## 21. Strings I
- [@173 @173 L1 - Eribelton e a Ascologia V1 - Somar Asc](base/173) 
- [@092 @092 L1 - LP da Xura - Inverter String!](base/092) 
- [@104 @104 L1 - Maiúsculo, Minusculo e Dígito!](base/104) 
- [@177 @177 L1 - Marileuza e as Alcaparras - Contar Ocorrencias!](base/177) 
- [@176 @176 L1 - Substring na decoração - Obter Substrings!](base/176) 
- [@174 @174 L1 - Valdiskey e a cifra V1!](base/174) 
- [@095 @095 L2 - Avestruz com Alcaparras](base/095) 
- [@096 @096 L2 - Contar Leds](base/096) 
- [@126 @126 L2 - Crushômetro](base/126) 
- [@109 @109 L2 - Eribelton e a Ascologia V2](base/109) 
- [@097 @097 L2 - Gagueira V1 - Duplicar Palavras](base/097) 
- [@093 @093 L2 - Gritando em Caixa Alta](base/093) 

## 22. Strings II

- [@180 @180 L2 - Guerra Civil no Universo Marvel](base/180) 
- [@089 @089 L2 - Mega Jokenpo!](base/089) 
- [@111 @111 L2 - Meu cachorro comeu minha tarefa](base/111) 
- [@125 @125 L2 - Numerão Divisível por 11](base/125) 
- [@110 @110 L2 - Organizando Ru - Homens e Mulheres!](base/110) 
...
- [@099 @099 L3 - Francês é Fresco](base/099) 
- [@120 @120 L3 - Gansos Gamados](base/120) 
- [@117 @117 L3 - Identificando Ultrons V2](base/117) 
- [@118 @118 L3 - Aniquilando Ultrons V3](base/118) 
- [@108 @108 L3 - Identificando elementos](base/108) 
- [@178 @178 L3 - Jack Sparrow e o Beijinho](base/178) 
- [@098 @098 L3 - Jason e Krueguer](base/098) 
- [@152 @152 L3 - Letras Ordenadas](base/152) 
- [@119 @119 L3 - Matéria e Antimatéia](base/119) 
- [@114 @114 L3 - MeU WoRd QuEbRoU](base/114) 
- [@102 @102 L3 - Meu cachorro comeu minha tarefa V2](base/102) 
- [@115 @115 L3 - Máquina de Datilografar Quebrada](base/115) 

## 24. Strings IV

- [@121 @121 L3 - Mário e o Assassins Creed](base/121) 
- [@122 @122 L3 - Nao se bububula - Gagueira V2!](base/122) 
- [@179 @179 L3 - Prof Muquirana - Busca máximo por critério](base/179) 
- [@112 @112 L3 - Rocicleia e o Locioreca - Anagramas!](base/112) 
- [@116 @116 L3 - Roda Roda Jequiti](base/116) 
- [@175 @175 L3 - Separando a partir de tokens](base/175) 
- [@103 @103 L3 - Separe Pneumatocito - Separação de Palavras!](base/103) 
- [@123 @123 L3 - Sorvete suor casaca chicletes - Letras em Comum!](base/123) 
...
- [@130 @130 L2 - Bingo!](base/130) 
- [@012 @012 L2 - Deu a louca no Imperador!](base/012) 
...
- [@131 @131 L2 - Matriz Simétrica](base/131) 
- [@150 @150 L2 - Soma de matrizes](base/150) 
- [@132 @132 L2 - Subdiagonais](base/132) 
- [@135 @135 L3 - Jogo da vida](base/135) 
...
- [@009 @009 L2 - Imprimir vetor formatado](base/009) 
- [@139 @139 L4 - A Porta Matemática](base/139) 
...
- [@145 @145 L2 - Contando ocorrências](base/145) 
- [@141 @141 L2 - Números de Fibonacci](base/141) 
- [@140 @140 L3 - Contando caracteres recursivamente](base/140) 
- [@146 @146 L3 - Torres de Hanoi](base/146) 
